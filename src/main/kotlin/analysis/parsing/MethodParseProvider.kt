...
//import analysis.items.methods.MethodIdentity
//import analysis.items.methods.MethodSummary
//import analysis.items.methods.MethodSummaryStorageOld
//import analysis.items.methods.extractors.getMethodFullName
//import analysis.items.methods.filter.MethodSummaryFilter
//import analysis.items.methods.normalizeAstLabel
//import analysis.items.methods.summarizers.MethodSummarizer
//import analysis.items.methods.summarizers.MethodSummarizersFactory
...
//    private val summaryStorageOld: MethodSummaryStorageOld,
...
//            )
//            if (summaryStorageOld.contains(realIdentity)) {
//                return@forEach
//            }
...
//                summaryStorageOld.add(methodSummary)
//            }
//        }
//    }
//
...
//        config.task, Granularity.METHOD, config.hideMethodName, config.filterPredicates, config.parser
//    )
//
